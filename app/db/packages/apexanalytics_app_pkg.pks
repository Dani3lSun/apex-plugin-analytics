CREATE OR REPLACE PACKAGE apexanalytics_app_pkg IS
  ...
  error_rest_insert         CONSTANT NUMBER := -20004;
  error_ipstack_generic     CONSTANT NUMBER := -20005;
  --
  ...
  -- #param p_app_id
  -- #return BOOLEAN
  FUNCTION is_login_background_enabled(p_app_id IN NUMBER) RETURN BOOLEAN;
  --
